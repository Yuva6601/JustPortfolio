    ...
    <div className="min-h-screen bg-[#020617] text-white">
      ...
      <main className="mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-4 py-20 sm:px-6 sm:py-24 lg:flex-row lg:items-center lg:gap-16">
        <section className="w-full max-w-2xl lg:grow">
          <span className="animate-fade-in-up mb-4 inline-flex rounded-full bg-violet-500/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-violet-300 shadow-sm ring-1 ring-violet-300/20 sm:text-sm">
            I&apos;m a web developer
          </span>

          <h1 className="animate-fade-in-up mt-4 text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl [animation-delay:0.2s]">
            Hi, I&apos;m <span className="text-[#8b5cf6]">Yuvanesh</span>
          </h1>

          <p className="animate-fade-in-up mt-5 max-w-xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8 [animation-delay:0.35s]">
          ...
          <div className="animate-fade-in-up mt-10 overflow-hidden rounded-[1.75rem] bg-slate-950/60 p-4 shadow-2xl shadow-black/20 backdrop-blur-xl [animation-delay:0.5s] sm:p-5">
